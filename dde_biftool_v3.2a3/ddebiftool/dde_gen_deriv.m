...
%
% <html>
% (c) DDE-Biftool v3.2a3 2022-04-03 (0ccf32f744ffb5e97639340b7de7d820093fae58)
...
elseif isempty(nx) && length(np)==2
    ...
    %% not implemented
    sv=num2str(size(v));
    error('dde_gen_deriv:notimplemented',...
        ['dde_gen_deriv: requested derivative nx=%s, np=%d, size(v)=(%s)',...
        ' does not exist!'],num2str(nx),np,sv);
end
end
